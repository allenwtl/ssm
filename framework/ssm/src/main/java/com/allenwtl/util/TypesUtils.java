...
//		try{boolean ok = target.getClass()==data.getClass();}
//		catch(Exception e){System.err.println("data=" + String.valueOf(data) + " target=" + String.valueOf(target) + " with ex:" + CommonUtils.formatThrowable(e));}
